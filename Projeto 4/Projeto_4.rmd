...
Essa variável é derivada da variável LoanStatus. Basicamente se o empréstimo já foi finalizado bem(Completed). Se está terminando(FinalPaymentInProgres), se por algum motivo foi cancelado(Cancelled) ou se está correndo sem problemas(Current) Ele é considerado um bom pagador. Caso contrário é um mal pagador.
