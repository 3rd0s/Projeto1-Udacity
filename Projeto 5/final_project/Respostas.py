...
soma = 0
for i in data_dict:
    soma += my_dataset[i]['poi']
SomaTotal = []
SomaAux = 0
for feature in features_list:
    for pessoa in my_dataset:
        if data_dict[pessoa][feature]=='NaN':
            SomaAux+=1
    SomaTotal.append(SomaAux)
    SomaAux=0
#Questao 1
print len(data_dict),soma,len(features_list)-1,SomaTotal
#Questao 2
print features_list
